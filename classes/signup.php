...
class Signup
{
	...
	public function evaluate($data)
	{
			...
			if($key == "email")
		{
			...
			{
				$this->error = $this->error . " email invalid!<br>";
			}
		}
	...
	public function create_user($data)
	{
		...
		$query = "insert into users (userid,first_name,last_name,gender,email,password,url_adress) values ('$userid' ,' $first_name' ,' $last_name' ,'$gender' ,'$email','$password','$url_adress')";
